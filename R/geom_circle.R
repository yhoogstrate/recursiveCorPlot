# This file was originally taken from: https://github.com/sctyner/geomnet
# The following pull request never got accepted upstream:
# https://github.com/sctyner/geomnet/pull/34
# Requiring to include the function in this R package.
